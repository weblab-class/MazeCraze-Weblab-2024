    ...
    <div className="text-4xl font-custom tracking-widest text-primary-text font-bold bg-primary-bg w-full h-full min-h-screen px-4 overflow-hidden flex justify-center items-center relative font-custom tracking-widest">
      ...
      <div className="bg-primary-block h-[60%] w-[88%] flex absolute p-8">
        <div className="bg-primary-pink h-full w-full z-50 flex justify-center items-center text-primary-bg text-xl p-5 text-wrap text-center">
          Welcome to Maze Craze. <br /> To play the game is simple. <br /> Use the keys specified in Customize
          page to navigate your character. <br /> When you become able to use perks you can press the
          spacebar to use them. <br /> Have fun and enjoy the chaos!
        </div>
      </div>
