    ...
    <div className="font-custom flex bg-primary-bg bg-opacity-70 w-full h-full min-h-screen items-center justify-center">
      ...
      {/*
            <div className="text-5xl text-primary-text font-bold grow text-center rounded-xl mx-16 border-spacing-4 bg-white h-3/4">
                ...
                <LeaderboardCard name="PLAYER" roundCoins="SCORE"/>

                {Object.keys(lobbyGameState.playerStats).map((userId) => (
                    <LeaderboardCard name={lobbyGameState.playerStats[userId].name} roundCoins={lobbyGameState.playerStats[userId].roundCoins}/>
                ))}
            </div>
